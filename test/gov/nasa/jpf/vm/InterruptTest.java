 ...
 */
public class InterruptTest extends RawTest {

  public static void main (String[] selectedMethods) {
    runTests( new InterruptTest(), selectedMethods);
  }


  //--- the test methods

  public static void testInterruptStatus () {
  ...
  public void testWaitSyncInterrupt() {
  ...
  public void testWaitAsyncInterrupt() {
    Runnable r = new Runnable(){
      public void run () {
        synchronized(this){
          // if we don't enter here, this should be reported as a deadlock
  ...
  public void testBlockedWaitAsyncInterrupt() {
    interrupted = false;
    waiting = false;
