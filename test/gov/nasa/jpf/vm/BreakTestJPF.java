...
/**
 * junit test driver for listeners breaking transitions
 */
public class BreakTestJPF extends TestJPF {
  static String[] jpfArgs = { "+jpf.listener=gov.nasa.jpf.vm.BreakTestListener" };
  ...
  public void testSimpleBreak () {
    noPropertyViolationThis(jpfArgs);
