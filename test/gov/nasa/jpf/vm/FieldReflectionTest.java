...
public class FieldReflectionTest extends RawTest {

  public static void main (String[] selectedMethods) {
    runTests( new FieldReflectionTest(), selectedMethods);
  }
  ...
  void testInstanceInt () {
    try {
      Class<?> cls = FieldReflectionTest.class;
