 ...
 */
public class ExceptionTestJPF extends TestJPF {
  ...
  @Test
  public void testNPE () {
    unhandledExceptionThis(NullPointerException.class);
  }
  ...
  public void testArrayIndexOutOfBoundsLow () {
    unhandledExceptionThis(ArrayIndexOutOfBoundsException.class);
  }
