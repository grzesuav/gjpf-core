...
public class LargeCodeTest extends RawTest {
  ...
  public void testGotoW () {
    int ret = switchIt(100);
    assert (ret == 10100)  : "wrong switchtable lookup";

    ret = switchIt(0);
    assert (ret == 42) : "goto_w failed";
  }
  
  public static void main (String[] selectedMethods){
    runTests( new LargeCodeTest(), selectedMethods);
  }
