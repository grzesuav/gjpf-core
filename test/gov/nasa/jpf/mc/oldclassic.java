...
/**
 * This example shows a deadlock which occurs as a result of a missed signal.
 * It also contains an assertion check that shows the race violation that is the
 * cause for the missed signal (and ultimate deadlock)
 * @author wvisser
 */
