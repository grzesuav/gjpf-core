...
implements java.io.Serializable, Comparable<String>, CharSequence {
	 ...
	 * constructors.
	 */
	/* NOT VISIBLE, but required for punched code*/
	...
	public String(byte bytes[], int offset, int length, Charset charset) {
		/* Need Charset model for this to work
	String proxy=init(bytes,offset,length,charset);
	this.value=proxy.value;
	this.count=proxy.count;
	this.hash=proxy.hash;
		 */
	...
	public String(StringBuffer buffer) {
		/* This will not work because no StringBuffer model
	 ...
	 */
	//void getChars(char dst[], int dstBegin);  NOT VISIBLE
