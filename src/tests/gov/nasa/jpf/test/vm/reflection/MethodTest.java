...
public class MethodTest extends TestJPF
{
  ...
  public void testMethodEquals() throws NoSuchMethodException {
    if (verifyNoPropertyViolation()) {
      Method foo1Test1 = ForMethodsTest1.class.getMethod("foo", int.class, boolean.class);
      Method foo1Test1New = ForMethodsTest1.class.getMethod("foo", int.class, boolean.class);
      Method foo2Test1 = ForMethodsTest2.class.getMethod("foo", int.class, boolean.class);
      Method fooTest2 = ForMethodsTest1.class.getMethod("foo", byte.class);

      assert foo1Test1.equals(foo1Test1New) == true;
      assert foo1Test1.equals(foo1Test1) == true;
      assert foo1Test1.equals(foo2Test1) == false;
      assert foo1Test1.equals(fooTest2) == false;
      assert foo1Test1.equals(null) == false;
    }
  }

  @Test
  public void testIsVarArgs() throws NoSuchMethodException {
    if (verifyNoPropertyViolation()) {
      Method foo = ForMethodsTest1.class.getMethod("foo", int.class, boolean.class);
      Method var = ForMethodsTest1.class.getMethod("var", int[].class);

      assert foo.isVarArgs() == false;
      assert var.isVarArgs() == true;
    }
  }
}

class ForMethodsTest1 {
  ...
  public void var(int... ia) {}
}

class ForMethodsTest2 {
